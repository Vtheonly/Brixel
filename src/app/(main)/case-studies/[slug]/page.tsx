    ...
    >
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl">
          <p className="text-sm md:text-base font-bold uppercase tracking-widest opacity-70 mb-4 font-sans">
            {project.partnerType}
          </p>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8 font-display">
            {project.heading}
          </h1>
          <p className="text-lg md:text-xl leading-relaxed opacity-90 max-w-2xl font-sans">
            {project.description}
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 pb-20 space-y-12 md:space-y-24">
        ...
        <div className="border-t border-gray-500/30 pt-10 mt-10">
            <Link href="/work" className="text-sm font-bold opacity-60 hover:opacity-100 transition-opacity font-sans">
                ← Back to All Work
            </Link>
        </div>
